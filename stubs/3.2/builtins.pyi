...
@overload
def max(iterable: Iterable[_T1], *, default: _T2) -> Union[_T1, _T2]: ...
@overload
def max(iterable: Iterable[_T1], *, key: Callable[[_T1], _T2]) -> _T1: ...
@overload
def max(iterable: Iterable[_T1], *, default: _T2, key: Callable[[_T1], _T3]) -> Union[_T1, _T2]: ...
@overload
def max(arg1: _T, arg2: _T, *args: _T) -> _T: ...
@overload
def max(arg1: _T1, arg2: _T1, *args: _T1, key: Callable[[_T1], _T2]) -> _T1: ...
# TODO memoryview
@overload
def min(iterable: Iterable[_T]) -> _T: ...
@overload
def min(iterable: Iterable[_T1], *, default: _T2) -> Union[_T1, _T2]: ...
@overload
def min(iterable: Iterable[_T1], *, key: Callable[[_T1], _T2]) -> _T1: ...
@overload
def min(iterable: Iterable[_T1], *, default: _T2, key: Callable[[_T1], _T3]) -> Union[_T1, _T2]: ...
@overload
def min(arg1: _T, arg2: _T, *args: _T) -> _T: ...
@overload
def min(arg1: _T1, arg2: _T1, *args: _T1, key: Callable[[_T1], _T2]) -> _T1: ...
@overload
